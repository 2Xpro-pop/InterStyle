		...
		<div class="container nav-row">
			...
			<div class="header-actions">
				...
				<div class="socials">
					...
					<a href="https://go.2gis.com/mdfKi" target="_blank" rel="noopener noreferrer" aria-label="2ГИС">
					...
					<a href="https://www.instagram.com/interstyle__osh" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
